...
import BACKEND_URL, { fn_compareTransactions, fn_deleteTransactionApi, fn_getAllMerchantApi, fn_updateTransactionStatusApi, PDF_READ_URL,fn_uploadTransactions } from '../../api/api';
...
const UploadStatement = ({ setSelectedPage, authorization, showSidebar }) => {
  ...
  const handleFileUpload = async (event) => {
    try {
      ...
      console.log("File input target:", fileInput);
