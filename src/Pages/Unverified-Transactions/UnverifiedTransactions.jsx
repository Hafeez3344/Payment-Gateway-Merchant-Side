...
const UnverifiedTransactions = ({ setSelectedPage, authorization, showSidebar }) => {
    ...
    >
      <div className="p-7">
        <div className="flex flex-col md:flex-row gap-[12px] items-center justify-between mb-7">
          <h1 className="text-[25px] font-[500]">Unverified Transactions</h1>
...
export default UnverifiedTransactions;
