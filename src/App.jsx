  ...
  return (
    <>
      ...
      <div>
        ...
        <Routes>
          <Route path="/login" element={<MerchantLogin authorization={authorization} setAuthorization={setAuthorization} setMerchantVerified={setMerchantVerified} />} />

          <Route path="/" element={<Home setSelectedPage={setSelectedPage} authorization={authorization} showSidebar={showSidebar} />} />

          <Route
            path="/transactions-table"
            element={<TransactionsTable setSelectedPage={setSelectedPage} authorization={authorization} showSidebar={showSidebar} />}
          />

          <Route
            path="/verified-transactions"
            element={<VerifiedTransactions setSelectedPage={setSelectedPage} authorization={authorization} showSidebar={showSidebar} />}
          />

          <Route
            path="/manual-verified"
            element={<ManualVerifiedTransactions setSelectedPage={setSelectedPage} authorization={authorization} showSidebar={showSidebar} />}
          />

          <Route
            path="/unverified-transactions"
            element={<UnverifiedTransactions setSelectedPage={setSelectedPage} authorization={authorization} showSidebar={showSidebar} />}
          />

          <Route
            path="/declined-transactions"
            element={<DeclinedTransactions setSelectedPage={setSelectedPage} authorization={authorization} showSidebar={showSidebar} />}
          />

          <Route
            path="/merchant-management"
            element={<MerchantManagement setSelectedPage={setSelectedPage} authorization={authorization} showSidebar={showSidebar} />}
          />

          <Route
            path="/reports-and-analytics"
            element={<ReportsAndAnalytics setSelectedPage={setSelectedPage} authorization={authorization} showSidebar={showSidebar} />}
          />

          <Route
            path="/support-help-center"
            element={<SupportHelpCenter setSelectedPage={setSelectedPage} authorization={authorization} showSidebar={showSidebar} />}
          />

          <Route
            path="/system-configuration"
            element={
              <SystemConfigurationIntegration setSelectedPage={setSelectedPage} authorization={authorization} showSidebar={showSidebar} setMerchantVerified={setMerchantVerified} />
            }
          />

          <Route
            path="/upload-statement"
            element={<UploadStatement setSelectedPage={setSelectedPage} authorization={authorization} showSidebar={showSidebar} />}
          />
        </Routes>
